    ...
    <section className="min-h-screen px-4 text-[#ed3833] bg-black">
      <div className="flex flex-col lg:flex-row-reverse justify-center items-center min-h-screen gap-0 md:gap-4">
        <div ref={body} className="flex flex-col short:gap-0 gap-2">
          ...
          className="flex flex-col text-base short:text-xs lg:text-[1.5vw] leading-[1rem] lg:leading-[1.4rem] tracking-[0.08em]">
            <p>office address</p>
          ...
          className="flex flex-col gap-2 short:gap-1">
            <div className="flex flex-col text-base short:text-xs md:text-[1.5vw] tracking-[0.08em] leading-[0.7rem] md:leading-none">
              <p>phone</p>
              <a href="tel:+3491700987165" className="text-2xl short:text-xl md:text-4xl font-bold">+34 91700987165</a>
            </div>
            <div className="flex flex-col text-base short:text-xs md:text-[1.5vw] tracking-[0.08em] leading-[0.7rem] md:leading-none">
              <p>booking enquires</p>
              <a href="mailto:ernesto@againstlt.com" className="text-2xl short:text-xl md:text-4xl font-bold">ernesto@againstlt.com</a>
            </div>
            <div className="flex flex-col text-base short:text-xs md:text-[1.5vw] tracking-[0.08em] leading-[0.7rem] md:leading-none">
              <p>press enquires</p>
              <a href="mailto:ernesto@againstlt.com" className="text-2xl short:text-xl md:text-4xl font-bold">manu@againstlt.com</a>
            </div>
            <div className="flex flex-col text-base short:text-xs md:text-[1.5vw] tracking-[0.08em] leading-[0.7rem] md:leading-none">
              <p>all other inquires</p>
              <a href="mailto:ernesto@againstlt.com" className="text-2xl short:text-xl md:text-4xl font-bold">info@againstlt.com</a>
            </div>
            {/* <div className="flex flex-col text-base short:text-xs md:text-[1.5vw] tracking-[0.08em] leading-[0.7rem] md:leading-none">
              <p>booking forms</p>
