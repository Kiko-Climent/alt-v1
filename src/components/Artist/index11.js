    ...
    <motion.section 
      ...
      <motion.div
        ...
        <div className="w-[90%] md:w-4/5 lg:w-1/3">
          <motion.img
            src={profilePicUrl}
            className="w-full min-h-[65vh] aspect-[4/5] object-cover lg:object-cover"
        ...
        >
          ...
          className="text-base short:text-xs lg:text-[1.5vw] leading-[1.15rem] lg:leading-6 font-bold text-justify">
...
export default ArtistProfile11;
