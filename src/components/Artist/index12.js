...
import BookingFormModal from "../Booking/BookingForm";



const ArtistProfile12 = ({data}) => {
  ...
  useEffect(() => {
    if (isModalOpen && data?.booking_form) {
  ...
  return (
    <motion.section 
      ...
      className="min-h-screen w-screen px-4 gap-0 text-[#ed3833] bg-black flex flex-col justify-center lg:justify-center items-center">
      ...
      <motion.div
        ...
        <div className="w-full md:w-4/5 lg:w-1/3">
          <img
            ...
            className="w-full min-h-[75vh] aspect-[4/5] object-cover lg:object-cover"
        ...
        >
          ...
          className="text-base lg:text-[1.5vw] leading-[1.15rem] lg:leading-6 font-bold text-justify">
          ...
          <motion.div
            ...
            className="flex flex-row lg:flex-col justify-between lg:justify-center gap-0 text-2xl lg:text-4xl font-bold mt-4 leading-7"
          >
...
export default ArtistProfile12;
