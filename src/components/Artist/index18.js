  ...
  return (
    <motion.section 
      ...
      <div className="flex flex-col pt-0 md:pt-2 w-full">
        ...
        >
          <p
            className="font-bold group hover:bg-[#ed3833] hover:text-black transform transition-colors duration-200"
            onClick={() => setIsModalOpen(true)}
          >
...
export default ArtistProfile18;
