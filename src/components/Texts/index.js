...
const LandingText = () => {
  ...
  return(
    <section className="relative h-screen w-full flex justify-end items-end overflow-hidden bg-black"
             onClick={handleNavigation} 
             onTouchStart={handleNavigation}>
      <div className="relative flex w-9/12 lg:w-3/12 px-4 py-2">
        <h1 className="text-[#811a17] text-3xl lg:text-3xl text-justify text-highlight !leading-7 md:!leading-6 blur-[0.5px] ">
        nuestro
